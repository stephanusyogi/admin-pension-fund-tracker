            ...
            <div class="grid grid-cols-12 gap-6">
                <div class="col-span-12 mt-8">
                  <div class="flex items-center" style="justify-content: space-between;">
                    <p class="text-xl font-semibold mb-2">Formulir Update Jenis Investasi Baru DAPENBI IP</p>
                    <div class="flex items-center gap-4">
                      <a href="<?= base_url() ?>setting-portofolio-ppip" class="btn btn-md btn-success">
                        Simpan
                      </a>
                    </div>
                  </div>
                    ...
                    <table class="table table-hover table-bordered" style="width:100%">
                      <thead>
                          <tr>
                            ...
                            <th colspan="2"><input type="text" class="form-control" placeholder="Masukkan Nama Investasi" value="Lorem Ipsum"></th>
                          </tr>
                          <tr>
                            <th>Informasi</th>
                            <th>Investasi</th>
