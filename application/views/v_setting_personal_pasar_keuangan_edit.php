            ...
            <div class="grid grid-cols-12 gap-6">
                <div class="col-span-12 mt-8">
                  <div class="flex items-center" style="justify-content: space-between;">
                    <p class="text-xl font-semibold mb-2">Formulir Update Jenis Investasi DAPENBI Personal Keuangan</p>
                    <div class="flex items-center gap-4">
                      <a href="<?= base_url() ?>setting-portofolio-personal-pasar-keuangan" class="btn btn-md btn-success">
                        Simpan
                      </a>
                    </div>
                  </div>
                    ...
                    <table class="table table-hover table-bordered" style="width:100%">
                      <thead>
                          <tr>
                            ...
                            <th><input type="text" class="form-control" placeholder="Masukkan Nama Investasi" value="Lorem Ipsum"></th>
                          </tr>
                          <tr>
                      ...
                      <tbody>
                        ...
                        <tr>
                          <th colspan="6" class="text-center">Asumsi korelasi antar aset  - Personal pada Pasar Keuangan</th>
                        </tr>
                        <tr>
