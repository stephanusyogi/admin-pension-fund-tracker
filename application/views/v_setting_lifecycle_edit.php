            ...
            <div class="grid grid-cols-12 gap-6">
                <div class="col-span-12 mt-8">
                  <div class="flex items-center" style="justify-content: space-between;">
                    <p class="text-xl font-semibold mb-2">Formulir Update Jenis Investasi DAPENBI LifeCycle</p>
                    <div class="flex items-center gap-4">
                      <a href="<?= base_url() ?>setting-komposisi-investasi-lifecycle-fund" class="btn btn-md btn-success">
                        Simpan
                      </a>
                    </div>
                  </div>
