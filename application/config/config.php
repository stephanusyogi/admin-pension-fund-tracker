...
|
*/
// $config['base_url'] = 'http://localhost/admin-pension-fund-tracker/';
$config['base_url'] = 'https://admin.yourpensiontracker.id/';
...
function custom_controleer($class) 
{
...
spl_autoload_register('custom_controleer');